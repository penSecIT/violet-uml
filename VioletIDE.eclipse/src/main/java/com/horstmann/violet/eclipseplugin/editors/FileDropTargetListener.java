...
/**
 * Class used to manage drag n' drop between Eclipse package explorer and Violet's editor instance. In other words, this is the most
 * important class to import Java files into diagrams.
 * 
...
public class FileDropTargetListener implements DropTargetListener
{
     ...
     * Default constructor
     * 
     * @param graphPanel containing the target graph
     */
    ...
    public void drop(DropTargetEvent event)
    {
        ...
        Point mouseLocationOnUMLGraphPanel = new Point(event.x - UMLGraphPanelLocationOnScreen.x, event.y
                - UMLGraphPanelLocationOnScreen.y);
    ...
    /**
     * Parses a Java file and creates a new node in the current diagram with its properties
     */
    ...
    /**
     * When the dropped file has Violet's extension, creates a diagram link on the current one
     */
