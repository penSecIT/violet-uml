...
package com.horstmann.violet.framework.diagram.edge;
...
public abstract class AbstractEdge implements IEdge
{
     ...
     * (non-Javadoc)
     * 
     * @see com.horstmann.violet.framework.diagram.Edge#getId()
     */
    public Id getId()
    {
        return this.id;
     ...
     * (non-Javadoc)
     * 
     * @see com.horstmann.violet.framework.diagram.Edge#setId(com.horstmann.violet.framework.diagram.Id)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.horstmann.violet.framework.diagram.Edge#getRevision()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.horstmann.violet.framework.diagram.Edge#setRevision(java.lang.Integer)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.horstmann.violet.framework.diagram.Edge#incrementRevision()
     */
    ...
    /* (non-Javadoc)
     * @see com.horstmann.violet.framework.diagram.Edge#getToolTip()
     */
