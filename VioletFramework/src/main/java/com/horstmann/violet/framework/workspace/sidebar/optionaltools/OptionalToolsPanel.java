...
package com.horstmann.violet.framework.workspace.sidebar.optionaltools;
...
public class OptionalToolsPanel extends JPanel implements ISideBarElement
{
     ...
     * (non-Javadoc)
     * 
     * @see com.horstmann.violet.framework.gui.sidebar.ISideBarElement#install(com.horstmann.violet.framework.gui.IDiagramPanel)
     */
