...
import com.horstmann.violet.framework.diagram.property.ChoiceList;
...
import com.horstmann.violet.framework.propertyeditor.customeditor.DiagramLinkEditor;
...
public class CustomPropertyEditor implements ICustomPropertyEditor
{
    ...
    /* (non-Javadoc)
     * @see com.horstmann.violet.framework.gui.IPropertyEditor#getAWTComponent()
     */
    ...
    /* (non-Javadoc)
     * @see com.horstmann.violet.framework.gui.IPropertyEditor#addPropertyChangeListener(java.beans.PropertyChangeListener)
     */
    ...
    /* (non-Javadoc)
     * @see com.horstmann.violet.framework.gui.IPropertyEditor#removePropertyChangeListener(java.beans.PropertyChangeListener)
     */
    ...
    /* (non-Javadoc)
     * @see com.horstmann.violet.framework.gui.IPropertyEditor#isEditable()
     */
